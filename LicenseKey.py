...
try:
    ...
    try:
        ...
        __import__('os').system(f'xdg-open https://wa.me/6283140199711?text=LICENSE%20ERROR%20%3A%20{quote(str(e))}')
        exit()
    except(Exception, KeyboardInterrupt) as e:
        from urllib.parse import quote
        __import__('os').system(f'xdg-open https://wa.me/6283140199711?text=LICENSE%20ERROR%20%3A%20{quote(str(e))}')
...
class LicenseKey:
    ...
    def Keys(self):
        ...
        if auth == 'beli' or xnxx == 'beli' or auth == 'beli':
           Console().print(f'\n [{H2}Premium Instagram And Facebook{P2}]\n\n {H2}01{P2}. 1 Minggu   : {H2}20.000\n {H2}02{P2}. 2 Minggu   : {H2}30.000\n {H2}03{P2}. 3 Minggu   : {H2}40.000\n {H2}04{P2}. 1 Bulan    : {H2}50.000\n\n {H2}P{P2}. Permanen   : {H2}150.000\n {H2}O{P2}. Open source {H2}250.000')
           choose = Console().input(f'\n {P2}[{H2}?{P2}] Choose : ')
           if choose =='1' or choose =='01':
              os.system(f'xdg-open https://wa.me/+6283140199711?text=assalamualaikum%20bang%20Zoraa%20Dev,%20beli%20license%20yang%201%20minggu%20dong') ; time.sleep(2) ; self.Keys()
           elif choose =='2' or choose =='02':
               os.system(f'xdg-open https://wa.me/+6283140199711?text=assalamualaikum%20bang%20Zoraa%20Dev,%20beli%20license%20yang%202%20minggu%20dong') ; time.sleep(2) ; self.Keys()
           elif choose =='3' or choose =='03':
               os.system(f'xdg-open https://wa.me/+6283140199711?text=assalamualaikum%20bang%20Zoraa%20Dev,%20beli%20license%20yang%203%20minggu%20dong') ; time.sleep(2) ; self.Keys()
           elif choose =='4' or choose =='04':
               os.system(f'xdg-open https://wa.me/+6283140199711?text=assalamualaikum%20bang%20Zoraa%20Dev,%20beli%20license%20yang%201%20bulan%20dong') ; time.sleep(2) ; self.Keys()
           elif choose =='P' or choose =='p':
               os.system(f'xdg-open https://wa.me/+6283140199711?text=assalamualaikum%20bang%20Zoraa%20Dev,%20beli%20license%20yang%20Permanen%20dong') ; time.sleep(2) ; self.Keys()
           elif choose =='O' or choose =='o':
               os.system(f'xdg-open https://wa.me/+6283140199711?text=assalamualaikum%20bang%20Zoraa%20Dev,%20beli%20Open%20Sourcenya%20dong') ; time.sleep(2) ; self.Keys()
        else:
           if len(auth) <=5:exit()
           else:self.confirm(auth)

    def confirm(self, keys, token = 'WyI5NTM0OTE0NiIsInlsWUp1R2FLWkJjRm1lSE1NQjR5b3NKZTdOQVg4RTFIcEJ6aGRSV08iXQ==', produc_id='27822'):
